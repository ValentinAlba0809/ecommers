...
const Item = ({
  ...
  return (
    <div className="card shadow" style={{ width: "20rem", margin: ".5rem" }}>
      <img
        src={img}
        className="card-img-top shadow rounded-2 object-fit-fill p-3"
        alt={title}
      />
      <div className="card-body">
        ...
        <Accordion defaultActiveKey="0">
          <Accordion.Item eventKey="1">
            <Accordion.Header>Mostrar Descripcion</Accordion.Header>
        ...
        {showDeleteButton || showEditButton ? (
          <div>
            <p className=" card-footer">Precio de compra: ${purchasePrice}</p>
